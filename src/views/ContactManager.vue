    ...
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">
          ...
          adipisci voluptate autem, cupiditate animi ipsam magnam laborum? Rem
          tenetur nobis, omnis error assumenda nam iste? Incidunt nam magni
          consectetur eos?
        </p>
        <form>
          <div class="row">
