    ...
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">
          ...
          error maiores corrupti recusandae accusantium quia laudantium,
          repellat nisi molestiae tempore quo tenetur voluptas praesentium,
          dolores eaque, adipisci distinctio cumque?
        </p>
      </div>
    </div>
  </div>
