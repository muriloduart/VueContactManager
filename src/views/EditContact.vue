    ...
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">
          ...
          culpa cupiditate dolorum, explicabo quaerat ullam nulla consequuntur
          eaque libero error! Quibusdam nemo eaque qui facilis quia soluta, sunt
          repellendus?
        </p>
      </div>
    </div>
    ...
    updateSubmit: async function () {
      try {
        ...
        if (response) {
          ...
          return this.$router.push(`${this.contactId}`);
        }
      } catch (error) {
        console.log(error);
      }
